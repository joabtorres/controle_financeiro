...
<header>
	<h3>
		...
		<small class="text-danger">Confira seus investimentos.</small>
	</h3> 
	<h4 class="text-right text-danger">Investimento Total: R$ <?php echo $investimento->numRows() > 0 ? number_format($investimento->getValorTotal(),2,",",".") : 0 ?></h4>
</header>
<articles>
	<p>
	<a href="/investimento/adicionar" class="btn btn-success">Adicionar</a>
	</p>
	<table class="table table-bordered table-hover">
		...
		<?php if($investimento->numRows() >0) :
		foreach ($investimento->getDados() as $value) : ?>
		<tr>
